...
<body>
  ...
  <section id="hero-animated" class="hero-animated d-flex align-items-center">
    <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
      <img src="{{$setting->path_logo}}" class="img-fluid animated">
      <h2>Welcome to <span>{{config('app.name')}}</span></h2>
      <p>Selamat Datang di {{config('app.name')}} Silahkah Login Atau Register Untuk Mengakses.</p>
      <div class="d-flex btn-group">
        <a href="{{route('login')}}" class="btn btn-info scrollto">Login</a>
        <a href="{{route('register')}}" class="btn btn-warning scrollto">Register</a>
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Diskon</a></h4>
              <p>Mendapatkan diskon ketika memiliki kartu member</p>
            </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Kartu Member</a></h4>
              <p>Mendapatkan Kartu Member ketika berbelanja</p>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="400">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Nota</a></h4>
              <p>Bisa Custom nota besar maupun kecil</p>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Payment </a></h4>
              <p>Terdapat menu kasir yang memudahkan pengguna</p>
            </div>
          </div><!-- End Service Item -->
    ...
    <div class="footer-legal text-center">
      <div class="container d-flex flex-column flex-lg-row justify-content-center justify-content-lg-between align-items-center">
        ...
        <div class="d-flex flex-column align-items-center align-items-lg-start">
          <div class="copyright">
            &copy; Copyright <strong><span>Abil Syarif H.</span></strong>. All Rights Reserved
          </div>
          <div class="credits">
